...
function ecouter(){
	new Ajax.Request('chat_import.php', { //PROTOTYPE API
...
function envoyer(){
	var connectes =$('amis'); //liste sur le lapiphone
	if( connectes.options.selectedIndex > -1 ){
		courant = connectes.select('option')[connectes.options.selectedIndex].innerHTML;
		new Ajax.Request('chat_send_message.php', { //PROTOTYPE API
