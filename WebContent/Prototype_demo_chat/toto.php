...
<html>
	...
	<body>
		...
		<h2>connect&eacute; en tant que 'toto'</h2>
		...
		<div id="lapiphone">
			...
			<div id="phone">
				...
				<div><form action="javascript:envoyer();">
					...
					<div class="centrer"><textarea class="centrer" id="message" name="message" rows="2" cols="14" ></textarea></div>
					<hr/>
